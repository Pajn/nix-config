    ...
    textobjects = {
      select = {
        ...
        keymaps = {
          ...
          ['ap'] = { query = '@variable.member.outer', desc = 'Select outer part of a property' },
          ['ip'] = { query = '@variable.member.inner', desc = 'Select inner part of a property' },
      ...
      move = {
        ...
        goto_next_start = {
          ...
          [']='] = { query = '@assignment.*', desc = 'Next part of an assignment' },
          [']a'] = { query = '@parameter.outer', desc = 'Next parameter/argument start' },
          [']p'] = { query = '@variable.member.outer', desc = 'Next property start' },
        ...
        goto_next_end = {
          ...
          [']P'] = { query = '@variable.member.outer', desc = 'Next property end' },
        },
        goto_previous_start = {
          ...
          ['[='] = { query = '@assignment.*', desc = 'Prev part of an assignment' },
          ['[a'] = { query = '@parameter.outer', desc = 'Prev parameter/argument start' },
          ['[p'] = { query = '@variable.member.outer', desc = 'Prev property start' },
        },
        goto_previous_end = {
          ...
          ['[P'] = { query = '@variable.member.outer', desc = 'Prev property end' },
        },
      },
      swap = {
        enable = true,
